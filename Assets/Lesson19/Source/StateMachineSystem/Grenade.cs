...
namespace MyLesson19
{
    namespace StateMachineSystem
    {
        public class Grenade
        {
            ...
            public Grenade(ICoroutineExecutable grenadeAction, Rigidbody grenadePrefab, Transform spawnPoint,
                Transform throwAnchor,
                float fuseTime, float explosionDelay, float throwForce, float torqueForce,
                float explosionForce, float explosionRadius, LayerMask layerMask,
                ExplosionController explosionParticles)
            {
                _fuseTime = fuseTime;
            ...
            private IEnumerator FuseRoutine()
            {
                ...
                ExplosionController explosion =
                    Object.Instantiate(_explosionParticles, _rigidbody.position, Quaternion.identity);
