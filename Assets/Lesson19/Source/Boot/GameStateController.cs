    ...
    namespace StateMachineSystem.GameStateSystem
    {
        public class GameStateController : GlobalMonoServiceBase, IGameStateProvider
        {
            ...
            private void Start()
            {
                ...
                _stateMachine.AddState((byte)GameState.MainMenu,
                    new MainMenu(_stateMachine, (byte)GameState.MainMenu, sceneManager, Scenes.MainMenu));
                _stateMachine.AddState((byte)GameState.Gameplay,
                    new Gameplay(_stateMachine, (byte)GameState.Gameplay, sceneManager, Scenes.Gameplay));
                _stateMachine.AddState((byte)GameState.Paused,
                    new Pause(_stateMachine, (byte)GameState.Paused, sceneManager, Scenes.Gameplay));
            }
